...
export interface IGatewayServer extends grpc.UntypedServiceImplementation {
  uploadCache: grpc.handleClientStreamingCall<proto_actions_cache_gateway_pb.UploadCacheRequest, proto_actions_cache_gateway_pb.UploadCacheResponse>;
...
export class GatewayClient extends grpc.Client {
  ...
  uploadCache(callback: grpc.requestCallback<proto_actions_cache_gateway_pb.UploadCacheResponse>): grpc.ClientWritableStream<proto_actions_cache_gateway_pb.UploadCacheRequest>;
  uploadCache(metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<proto_actions_cache_gateway_pb.UploadCacheResponse>): grpc.ClientWritableStream<proto_actions_cache_gateway_pb.UploadCacheRequest>;
  uploadCache(metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<proto_actions_cache_gateway_pb.UploadCacheResponse>): grpc.ClientWritableStream<proto_actions_cache_gateway_pb.UploadCacheRequest>;
